        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contat_no = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    city = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    state = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    A = table.Column<bool>(type: "bit", nullable: false),
                    A_positve = table.Column<bool>(type: "bit", nullable: false),
                    B = table.Column<bool>(type: "bit", nullable: false),
                    B_positve = table.Column<bool>(type: "bit", nullable: false),
                    C = table.Column<bool>(type: "bit", nullable: false),
                    C_positve = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beneficiary_Hospital_HospitalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beneficiary_HospitalId",
                table: "Beneficiary",
                column: "HospitalId");
